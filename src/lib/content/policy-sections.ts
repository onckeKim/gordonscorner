...
export const privacyDefaults: PolicyItem[] = [
  ...
  { id: 'data-access-correction', title: 'Data-access and correction requests', content: 'You may request a copy of the personal information we hold about you, or ask us to correct inaccurate information, by contacting us directly.' },
  { id: 'data-deletion', title: 'Data-deletion requests', content: 'You may request deletion of your personal information, subject to our legal obligation to retain certain booking and financial records for the statutory period.' },
